...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:DISCO_F303VC
#define KVSTORE_ENABLED                                                       1                                                                                                // set by library:kvstore
#define LPTICKER_DELAY_TICKS                                                  1                                                                                                // set by target:FAMILY_STM32
#define MBED_CONF_APP_SD_CLK                                                  PB_13                                                                                            // set by application
#define MBED_CONF_APP_SD_CS                                                   PB_12                                                                                            // set by application
#define MBED_CONF_APP_SD_FREQ                                                 25000000                                                                                         // set by application
#define MBED_CONF_APP_SD_MISO                                                 PB_14                                                                                            // set by application
#define MBED_CONF_APP_SD_MOSI                                                 PB_15                                                                                            // set by application
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                        0                                                                                                // set by target:DISCO_F303VC
